"""
Description:
    For now, I will place environment creation code here.
    In the future, this code for creating environments will become more complicated for creating
...
def create_environment(env_name: str, render: bool = False):
    """
    Create the environment given its name.
    In the future, this function can be modified to support many more environments.

    Args:
        env_name (str): The environment to be created. Example: "simple_adversary_v3"
