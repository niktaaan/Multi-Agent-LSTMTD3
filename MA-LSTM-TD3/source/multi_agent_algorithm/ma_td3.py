"""
Description:
    This is a version of the MADDPG algorithm where TD3 is being used instead of DDPG.
...
import torch
import numpy as np
from source.multi_agent_algorithm.agent_td3 import TD3
