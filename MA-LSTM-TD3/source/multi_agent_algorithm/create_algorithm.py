"""
Description:
    Given arguments and hyperparameters,
    the functions will create the appropriate multi-agent algorithm and return them.
...
def create_algorithm(
    ...
    """
    # there is a bug when loading environments from checkpoints
    # the environment has terminated
    # easy bug fix: just create a temporary deepcopy of the environment, reset it, and use it for setup here
