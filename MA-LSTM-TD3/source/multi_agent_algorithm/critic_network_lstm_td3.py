...
class CriticLSTMTD3(torch.nn.Module):
    ...
    The critic is a variant of the MADDPG algorithm.
    The critic receives state information that is the concatenation of all agents' observations and actions.
    The critic state histories also are the concatenation of all agents' observations and actions.
    """
    def __init__(
            self,
