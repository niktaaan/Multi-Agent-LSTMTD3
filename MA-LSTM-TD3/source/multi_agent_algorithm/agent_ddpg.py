"""
Description:
    The Deep Deterministic Policy Gradient (DDPG) agent required for MADDPG algorithm is coded here.
...
class DDPG:
    """
    A Deep Deterministic Policy Gradient (DDPG) agent requires,
    ...
    For the MADDPG algorithm,

    (*) Actor networks only get the agent's observation information.
    (*) Critic networks get all agents' observations and actions.
    """
    def __init__(
            self,
            name: str,
