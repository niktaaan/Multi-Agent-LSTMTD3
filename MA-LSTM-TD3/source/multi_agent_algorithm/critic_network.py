"""
Description:
    A generic critic network for an Actor-Critic reinforcement learning agent is coded here.
...
class CriticNetwork(torch.nn.Module):
    """
    The critic network for a multi-agent algorithm where the states and actions of all agents are
